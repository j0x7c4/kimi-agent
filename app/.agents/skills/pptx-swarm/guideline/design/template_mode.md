...
- **Preset template**: Specify the template file used (`template/{name}/{name}.pptd`) and style file (`guideline/design/profiles/{profile}.md`)
...
| Blue-White Minimalist II | `template/academic-6/academic-6.pptd` | `profiles/academic.md` | Academic reports, thesis defense |
| Purple Serene II | `template/academic-7/academic-7.pptd` | `profiles/academic.md` | Academic lectures, thesis defense |
| Lake Blue Navigation | `template/academic-8/academic-8.pptd` | `profiles/academic.md` | Research presentations, academic reports |
| Dark Data Screen | `template/business_insight-8/business_insight-8.pptd` | `profiles/business_insight.md` | Data-driven business analysis, financial reports |
| Bain Red Consulting | `template/business_insight-10/business_insight-10.pptd` | `profiles/business_insight.md` | Consulting reports, strategic analysis |
| CICC Blue Gold | `template/business_insight-11/business_insight-11.pptd` | `profiles/business_insight.md` | Investment research, financial analysis |
| Bain & Company Style | `template/business_insight-16/bain.pptd` | `profiles/business_insight.md` | Consulting strategy reports, business analysis |
| Handwritten Creative Portfolio | `template/promotion-5/promotion-5.pptd` | `profiles/promotion.md` | Creative portfolios, personal brand showcase |
| Midnight Blue Copper II | `template/strategic-5/strategic-5.pptd` | `profiles/strategic.md` | Corporate strategic planning, board presentations |
| The Vanguard | `template/strategic-6/strategic-6.pptd` | `profiles/strategic.md` | Strategic planning, business transformation |
| The Dark Matter | `template/strategic-7/strategic-7.pptd` | `profiles/strategic.md` | Tech strategic planning, product strategy |
| The Architecture | `template/strategic-8/strategic-8.pptd` | `profiles/strategic.md` | Sustainability strategy, ESG reports |
